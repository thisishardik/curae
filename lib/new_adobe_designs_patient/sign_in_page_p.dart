...
class AdobeSignInPatient extends StatefulWidget {
  @override
  _AdobeSignInPatientState createState() => _AdobeSignInPatientState();
}

class _AdobeSignInPatientState extends State<AdobeSignInPatient> {
  String username;
  String password;
