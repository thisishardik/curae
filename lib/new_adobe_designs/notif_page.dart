...
class AdobeNotificationPage extends StatefulWidget {
  @override
  _AdobeNotificationPageState createState() => _AdobeNotificationPageState();
}

class _AdobeNotificationPageState extends State<AdobeNotificationPage> {
