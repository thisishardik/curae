...
class AdobeOTPScreen extends StatefulWidget {
  static String id = 'otp_screen';
  @override
  _AdobeOTPScreenState createState() => _AdobeOTPScreenState();
}

class _AdobeOTPScreenState extends State<AdobeOTPScreen> {
          ...
          children: [
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  /// For verification add error controller
