...
class AdobeSignUpDoctor extends StatefulWidget {
  @override
  _AdobeSignUpDoctorState createState() => _AdobeSignUpDoctorState();
}

class _AdobeSignUpDoctorState extends State<AdobeSignUpDoctor> {
  String username;
  String name;
  String email;
  String number;
