...
import 'package:biocom2/welcome_animation/fade_animation.dart';

class WelcomeAnimation extends StatefulWidget {
  static String id = "welcome_animation";
  @override
          ...
          ..addStatusListener((status) {
            if (status == AnimationStatus.completed) {
              Navigator.push(
                  context,
                  PageTransition(
                      type: PageTransitionType.fade, child: ChooseTypePage()));
            }
          });
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FadeAnimation(
                      1.3,
                      Text(
                        "Your health is our concern. Bringing exceptional care close to you. ",
                        style: TextStyle(
